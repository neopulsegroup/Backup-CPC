...
export default function HowItWorks() {
  ...
  return (
    <Layout>
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-12">
                  ...
                  <div className="flex-1 cpc-card p-6 md:p-8">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h3 className="text-xl font-bold">{t.get(`howItWorks.migrantSteps.${step.key}.title`)}</h3>
                    </div>
                    <p className="text-muted-foreground leading-relaxed">
                      {t.get(`howItWorks.migrantSteps.${step.key}.description`)}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="cpc-section bg-muted/30">
        <div className="cpc-container">
          <div className="max-w-3xl mx-auto cpc-card p-8 md:p-10">
            <h2 className="text-2xl md:text-3xl font-bold mb-6">{t.howItWorks.companyHeading}</h2>
            <p className="text-muted-foreground mb-4 leading-relaxed">{t.howItWorks.companyLead}</p>
            <ul className="list-disc pl-5 space-y-2 text-muted-foreground mb-6 leading-relaxed">
              <li>{t.howItWorks.companyBullet1}</li>
              <li>{t.howItWorks.companyBullet2}</li>
            </ul>
            <p className="text-muted-foreground leading-relaxed">{t.howItWorks.companyMatch}</p>
          </div>
        </div>
      </section>
      ...
      <section className="cpc-section">
        <div className="cpc-container text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">{t.howItWorks.ctaTitle}</h2>
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">{t.howItWorks.ctaSubtitle}</p>
